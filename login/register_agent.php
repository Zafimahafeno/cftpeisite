          ...
          <div class="col-md-6 col-lg-4">
            <div class="login-wrap p-0">
              ...
              <form action="register_back.php" method="post" enctype="multipart/form-data" class="signin-form">
                ...
                <div class="form-group">
                  <input id="mail_employeur-field" type="email" class="form-control" placeholder="votre adresse mail" required name="mail">
                </div>
                <div class="form-group">
                  <input id="password-field" type="password" class="form-control" placeholder="votre mot de passe" required name="password">
