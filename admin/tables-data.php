...
$etudiants = $pdo->query("SELECT cv FROM register")->fetchAll(PDO::FETCH_ASSOC);
?>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Listes des étudiants inscrit</h5>
              ...
              <table class="table datatable">
                ...
                <?php foreach ($etudiants  as $file): ?>
                        <tr>
                        <td><?= htmlspecialchars(basename($file['cv'])) ?></td>

                            
                            <td>
                                <a href="download.php?file=<?= urlencode($file['cv']) ?>" class="btn btn-success btn-sm">Télécharger</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
